...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-grid-slate-900/[0.04] relative overflow-hidden">
      ...
      <motion.div
        className="absolute inset-0 bg-gradient-to-br from-blue-500/20 via-indigo-500/10 to-transparent"
        style={{ opacity: scrollYProgress }}
      />

      {/* Hero Section */}
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center px-6 bg-gradient-to-r from-blue-600 to-indigo-600">
        <motion.div
        ...
        >
          <motion.h1
            ...
            className="text-6xl md:text-8xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-pink-400 leading-[1.1]"
          >
            Revolutionize Your{' '}
            <span aria-label="Digital Identity" className="text-white">
              Digital Identity
            </span>
          </motion.h1>
          <motion.div
          ...
          >
            <Link href="/create">
              <button
                ...
                className="group relative px-8 py-4 bg-gradient-to-r from-yellow-500 to-pink-500 rounded-full font-semibold hover:scale-[1.03] transition-transform duration-300"
              >
                <span className="relative z-10">Start Creating</span>
                <div className="absolute inset-0 bg-gradient-to-r from-yellow-400 to-pink-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10" />
        ...
        >
          {['AI Design Engine', 'Dynamic NFT Links', 'Real-time Analytics'].map((title, i) => (
            <motion.div
              ...
              className="bg-gray-900/50 backdrop-blur-xl p-8 rounded-2xl border border-gray-800 hover:border-blue-400/30 transition-colors duration-300"
            >
              <div className="text-blue-400 text-4xl mb-4">0{i + 1}</div>
        ...
        >
          <div className="flex-1 space-y-6">
            ...
            <div className="flex gap-4">
              <button className="px-6 py-3 rounded-full bg-gray-900 border border-gray-800 hover:border-blue-400 transition-colors">
                View Demo
              </button>
              <button className="px-6 py-3 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:scale-[1.02] transition-transform">
                Start Creating
              </button>
            </div>
          </div>
          {/* 3D Preview Area */}
          <div className="flex-1 relative h-[400px] bg-gray-900/50 backdrop-blur-xl rounded-2xl border border-gray-800">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-64 h-64 bg-gradient-radial from-blue-500/20 to-transparent rounded-full" />
            </div>
            <motion.div
            ...
            >
              <div className="w-48 h-72 bg-gray-800 rounded-xl transform-gpu shadow-2xl relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-indigo-500/10" />
                <div className="p-6 relative z-10">
                  <div className="h-8 w-8 bg-blue-400 rounded-full mb-12" />
      ...
      <section ref={qrRef} className="relative py-32 px-6">
        ...
        >
          <h2 className="text-4xl font-bold text-white mb-8">Smart Integration</h2>
          <motion.div
            className="inline-block bg-gray-900/50 backdrop-blur-xl p-6 rounded-2xl border border-gray-800 hover:border-blue-400 transition-colors"
          ...
          >
            ...
            />
            <div className="mt-4 text-blue-400 font-medium">Dynamic Content QR</div>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section ref={footerRef} className="relative py-32 px-6">
        ...
        >
          <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-12 border border-gray-800 relative overflow-hidden">
            ...
            <Link href="/create">
              <button className="px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full font-semibold hover:scale-[1.02] transition-transform">
                Start Your Journey
              </button>
            </Link>
          </div>
